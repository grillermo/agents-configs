...
SCRIPT="$ROOT_DIR/skills/serve/scripts/serve-shortcut.sh"
...
assert_exit 66 "$SCRIPT" "/tmp/serve-skill-missing-file"
...
assert_contains "shortcuts run serve file --input-path $canonical_tmp_file" "$output"
